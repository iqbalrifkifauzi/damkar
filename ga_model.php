...
- (right(curdate(),5) < right(tgl_perolehan,5))+$pilihan) as bulan,c.*,d.* from tbl_sptrd_perolehan a 
	...
	function GetTahunPendataan () {
		return $this->db->query("select tanggal_perpanjang_retribusi from tbl_perpanjang_retribusi group by tanggal_perpanjang_retribusi order by tanggal_perpanjang_retribusi asc");
	}
