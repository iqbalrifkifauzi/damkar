							...
							<div class="portlet-body form">
								...
								<div class="form-horizontal">
									...
									<div class="control-group">
												...
												<div id="pilihantahun">
												<div class="controls">
													<select id="select2_sample22" name="tanggal_perpanjang_retribusi" class="span6 select2">
														<option value=""></option>
														<?php
														foreach ($data_tahun->result_array() as $tampil) { ?>
															<option value="<?php echo $tampil['tanggal_perpanjang_retribusi'];?>"><?php echo $tampil['tanggal_perpanjang_retribusi'];?> </option>
														<?php
														}
														?>
													</select>
